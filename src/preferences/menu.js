    ...
    const actions = [
        {
            ...
            link: 'https://github.com/aunetx/notebook-manager/issues'
        },
        {
            name: 'open-readme',
            link: 'https://github.com/aunetx/notebook-manager'
        },
        {
            name: 'open-license',
            link: 'https://github.com/aunetx/notebook-manager/blob/master/LICENSE'
        },
        {
            name: 'donate-github',
